<script lang="ts">
    ...
    onMount(() => {
        ...
        if(urlParams) {
            cameFrom = urlParams.get('cameFrom');
    ...
    function finishRegistration() {
        ...
        if (cameFrom) {
            window.location.href = cameFrom; // Redirect back to the page specified in the query parameter
        }
    }
</script>

<div class="max-w-xl m-auto my-20 border-2 bg-white rounded-xl p-10 shadow-xl">
